...
export interface ICustomerTemplateRepository {
    ...
    getCustomerTemplateByTypeAndCustomerId(customerId: number, templateType: string, customerTemplateMasterId: number | null): Promise<CustomerTemplateWithCustomerTemplateRepo[]>;
